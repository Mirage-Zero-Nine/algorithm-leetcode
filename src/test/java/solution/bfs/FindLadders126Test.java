...
public class FindLadders126Test {
    ...
    public void test() {
        ...
        list = Lists.newArrayList("ted", "tex", "red", "tax", "tad", "den", "rex", "pee");
        expected = Lists.newArrayList(
        ...
        list = Lists.newArrayList("hot", "dot", "dog", "lot", "cog");
        temp = Lists.newArrayList("hit", "hot", "dot", "dog", "cog");
        expected = Lists.newArrayList();
        expected.add(temp);
        assertIterableEquals(expected, test.findLadders("hit", "cog", list));
